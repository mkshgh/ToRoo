...
fn main() {
    ...
    // delete_tsv("2023-02-15T09:26:32.233z".to_string());
    read_tsv(0)
...
fn update_tsv(id:String,new_task_list:String) -> bool {
    ...
    let mut file = File::open(file_path).expect("Cannot Access DB file");
    ...
    for data in buffer.lines().peekable(){
...
fn delete_tsv(id:String) -> bool{
    update_tsv(id,"".to_owned());
    true
}
